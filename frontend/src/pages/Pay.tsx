...
function Pay() {
  ...
  const tabs = [
    { id: 'send', label: 'Send', icon: ArrowUpRight, description: 'Transfer assets' },
    { id: 'receive', label: 'Receive', icon: ArrowDownLeft, description: 'Get QR code' },
  ]
    ...
    <div className="min-h-screen text-white">
      ...
      <div className="mb-8">
        <div className="text-center">
          ...
          <p className="text-white/70">Send and receive digital assets instantly</p>
        </div>
      </div>
      ...
      <div className="min-h-[500px]">
        ...
        {activeTab === 'receive' && (
          <div className="space-y-6">
            ...
            {/* Address Display */}
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-xl">
              <h3 className="font-bold text-white mb-4">Your Wallet Address</h3>
              ...
              <p className="text-sm text-white/70 mt-3">
                Share this address to receive payments from any compatible wallet
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-red-500/20 to-yellow-500/20 rounded-2xl p-6 border border-red-500/30 backdrop-blur-sm">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-white">Scan to Pay</h3>
                  <p className="text-sm text-white/70">Let others scan your QR code</p>
                </div>
              </div>
